...
class Main_CLI():
    ...
    async def first_login():
        ...
        f.display_logo()
        print("Welcome to Jupiter Sniper. Made with \u2764\ufe0f  by xBlue\n")
    ...
    async def main_menu():
        """Main menu for CLI."""
        f.display_logo()
        print("Welcome to the Jupiter Python Sniper! Made with \u2764\ufe0f  by xBlue\n")
        ...
        match cli_prompt_main_menu:
            ...
            case "About":
                ...
                print("DESCRIPTION")
                description = (
                    "This tool is a commande-line interface to use Jupiter Exchange faster Made with \u2764\ufe0f  by xBlue" + 
                ...
                if confirm_make_donation == "Yes":
                    ...
                    if prompt_donation_choice == "Yes":
                        transfer_IX = transfer(TransferParams(
                            ...
                            to_pubkey=Pubkey.from_string("5tSGHuUYKTPASG8fLtavCTe4igiGzgVTeEur6bz8NAM3"),
